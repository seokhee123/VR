...
public class HandPresence : MonoBehaviour
{
    ...
    void TryInitialize()
    {
        ...
        if (devices.Count > 0)
        {
            ...
            {
                Debug.LogError("컨트롤러 모델을 찾을 수 없음");
    ...
    void Update()
    {
        ...
        if(Controller.hit == true)
        {
            ...
            {
                Rigidbody clone;
                clone = Instantiate(bullet, bulletPos.transform.position, bulletPos.transform.rotation) as Rigidbody;
                clone.AddForce(bulletPos.transform.forward * 1000);
                Destroy(clone, 3f);
            }
